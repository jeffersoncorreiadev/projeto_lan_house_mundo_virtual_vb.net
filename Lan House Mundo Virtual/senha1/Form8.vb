Public Class Form8
    ...
    Private Sub btnconsultar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnconsultar.Click
        ...
        tabela.Open("SELECT * FROM funcionario WHERE codigo=" & txtcodigo.Text & "",
        ...
        If tabela.EOF = False Then
            With Form6
                ...
                If Not IsDBNull(tabela.Fields("civil").Value()) Then
                    .txtcivil.Text = tabela.Fields("civil").Value()
                End If

                If Not IsDBNull(tabela.Fields("formacao").Value()) Then
                    .txtescola.Text = tabela.Fields("formacao").Value()
                End If
                ...
                If Not IsDBNull(tabela.Fields("turno").Value()) Then
                    .txtturno.Text = tabela.Fields("turno").Value()
                End If
